    ...
    <>
      <header className="border-b border-navy/5 bg-white/60 backdrop-blur-sm sticky top-0 z-40">
        <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-navy/50 -mt-0.5">De Gabriel Tsecos</p>
          </div>
          <nav className="hidden md:flex items-center gap-10">
            <a href="#servicios" className="text-sm text-navy/60 hover:text-navy transition-colors">Servicios</a>
            <a href="#contacto" className="text-sm text-navy/60 hover:text-navy transition-colors">Contacto</a>
          </nav>
        </div>
      </header>
      ...
      <section className="max-w-6xl mx-auto px-6 py-28 md:py-36">
        <div className="max-w-2xl">
          ...
          <p className="text-navy/60 leading-relaxed text-lg mb-12 max-w-xl">
      ...
      <section className="py-24 max-w-6xl mx-auto px-6 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-xl md:text-2xl leading-relaxed font-semibold text-navy/70">
      ...
      <section id="contacto" className="border-t border-navy/5 py-24 bg-white/40">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="text-navy/60 mb-10 max-w-md mx-auto">
      ...
      >
        <div className="w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center shadow-lg shadow-[#25D366]/30 hover:scale-105 transition-transform">
